          ...
          <Box className={classes.container}>
            <Box className={classes.linkContainer}>
              <Box className={classes.linkBox1}>
                ...
                <Typography
                  style={{ fontSize: "11px",color: "#ffffff",marginBottom: "0.7rem"}}
                   variant="h6"
                >
              ...
              <Box style={{ width: "11rem" ,marginTop: '111px'}}>
              <Typography
              ...
              <Box style={{ width: "11rem", marginBottom: "1.5rem" }}>
                <Typography
                  className={classes.header}
                  style={{ fontSize: "0.9rem", marginBottom: "0.7rem" }}
                  variant="h6"
