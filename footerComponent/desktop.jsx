          ...
          <Box className={classes.container}>
            <Box className={classes.linkContainer}>
              <Box className={classes.linkBox1}>
                ...
                <Box  >
                <Typography
                  style={{ fontSize: "12px",color: "#BCE0F9",marginBottom: "1.7rem",lineHeight:'1.7rem'}}
                   variant="h6"
                >
                 <b style={{ fontSize: "0.7rem",color: "#ffffff"}}>UK OFFICE</b><br />
										Suite 143 548-550 Elder Gate,
										Milton Keynes, MK9 1LR
                </Typography>
                <Typography
                style={{ fontSize: "12px",color: "#BCE0F9",lineHeight:'1.7rem'}}
                   variant="h6"
                >
                 <b style={{ fontSize: "0.7rem",color: "#ffffff" }}>LAGOS OFFICE</b><br />
              ...
              <Box style={{ width: "10rem", marginBottom: "1.5rem" }}>
                ...
                <Typography
                  ...
                  fontWeight: 600,
                  color: "#BCE0F9",marginBottom: "0.8rem"}}
                  variant="h6"
                >
                  CONTACT US
